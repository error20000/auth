	...
	new Vue({
		...
		methods: {
			...
			getList: function () {
				...
				var url = baseUrl+"manage/player/find_paged_by_name.json";
				ajaxReq(url, {rows : params.rows, pageIndex: params.page,token: token, uid: uid, sortKeys: JSON.stringify({"timeRegister":-1}), conditions: JSON.stringify(condition) }, function(res){
